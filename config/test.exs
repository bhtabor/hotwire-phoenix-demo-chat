...
config :hotwire_phoenix_demo_chat, HotwirePhoenixDemoChat.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "hotwire_phoenix_demo_chat_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :hotwire_phoenix_demo_chat, HotwirePhoenixDemoChatWeb.Endpoint,
  ...
  secret_key_base: "vfAbEv/1FfzKCCL/C0VutvP4zgG0OAHOJ9h0YlY2JXqsHkHU/sRTmFbihIbRtFb1",
  server: false
